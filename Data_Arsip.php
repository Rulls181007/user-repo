...
<head>
    ...
    gap: 16px; /* Jarak antara gambar dan deskripsi */
    max-width: 950px; /* Ukuran maksimal */
    width: 100%;
    margin: 0 auto;
    border: 1px solid #ddd;
    border-radius: 8px;
...
.form-content {
    ...
    flex-grow: 1; /* Konten teks menempati sisa ruang */
}
...
.sejarah-section {
    flex: 1; /* Memungkinkan lebar fleksibel */
    max-width: 45%; /* Atur batas maksimal */
}
...
<body>
    ...
    <div class="sejarah-section">
        ...
        <!-- Form lainnya bisa ditambahkan di sini -->
    </div>
    ...
    <div class="artikel-section">
        ...
        <div class="form-container">
            <img src="images/libur.jpg" alt="Sample Image">
            <div class="form-content">
                <h3>Artikel Libur Satu Bulan</h3>
                <p>Desa Cigentur terletak di bagian selatan Kecamatan Tanjungkerta. Wilayah ini memiliki posisi strategis karena dilewati jalan penghubung utama antar daerah.</p>
                <a href="tampillibur.php" class="button">Selengkapnya</a>
            </div>
            </div>
        </div>
    </div>
